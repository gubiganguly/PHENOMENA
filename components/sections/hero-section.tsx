  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center text-center space-y-8 sm:space-y-12 md:space-y-16 px-4 sm:px-6 md:px-8">
        ...
        {/* Scrolling brand logos - moved below timer with smaller text */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <ScrollVelocity baseVelocity={-2} className="text-sm sm:text-base md:text-lg lg:text-xl font-bold text-white/20 tracking-wider">
            {brandLogos.join(" • ")} •
          </ScrollVelocity>
        </motion.div>
      </div>
